            ...
            <div id="content" class="reservation">
                <div class="container section">
                    <div class="one-third column">
                        <h3 class="nobg">Syarat-syarat Umroh</h3>
                        <ol>
                        <li>Bagi muslim yang ingin menunaikan ibadah umroh perlu memperhatikan syarat-syarat sebagai berikut :</li>
                        <li>Sehat jasmani maupun rohani</li>
                        <li>Memilik dokumen perjalanan yaitu; Paspor, Buku ICV Meningitis</li>
                        <li>Memilih tanggal keberangkatan</li>
                        <li>Membayar biaya akomodasi selama perjalanan ibadah Umroh (sesuai Program yang dipilih)</li>
                    ...
                    <div class="two-third column">
                        <h3 class="nobg">Prosedur Mendaftar Umroh di PT. Ameera Hati Mulia :</h3>
                        <ol>
                        <li>Mengisi form pendaftaran melaui Agen/Cabang/Langsung ke Kantor Pusat</li>
                        <li>Membayar biaya DP sebesar Rp 5.000.000,-/orang atau membayar Pelunasan sesuai program</li>
                        <li>Menerima paket perlengkapan meliputi; Koper, Tas Cabin, Tas selempang, Alat Ibadah (Ihram bagi laki-laki, Jilbab/Kerudung/Mukena bagi wanita), Seragam, Buku Tuntunan Ibadah/Do’a</li>
                        <li>Melampirkan dokumen kependudukan yaitu ; Fotokopi KTP, Fotokopi KK, Fotokopi Surat Nikah/ Akta Kelahiran/ Ijazah </li>
                        <li>Melampirkan pas foto berwarna ukuran 4x6 (3 lembar)</li>
