        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <?php
              $query = $this->db->query("SELECT * FROM haji WHERE paket='Haji VVIP'");
              $jml = $query->num_rows();
              ?>
              <div class="info-box-content">
                <span class="info-box-text">Haji VVIP</span>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <?php
              $query = $this->db->query("SELECT * FROM haji WHERE paket='Haji VIP'");
              $jml = $query->num_rows();
              ?>
              <div class="info-box-content">
                <span class="info-box-text">Haji VIP</span>
                <span class="info-box-number"><?php echo $jml; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <?php
              $query = $this->db->query("SELECT * FROM haji WHERE paket='Umroh VIP'");
              $jml = $query->num_rows();
              ?>
              <div class="info-box-content">
                <span class="info-box-text">Umroh VIP</span>
                <span class="info-box-number"><?php echo $jml; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <?php
              $query = $this->db->query("SELECT * FROM haji WHERE paket='Umroh Reguler'");
              $jml = $query->num_rows();
              ?>
              <div class="info-box-content">
                <span class="info-box-text">Umroh Reguler</span>
                <span class="info-box-number"><?php echo $jml; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
