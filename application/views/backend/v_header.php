...
<header class="main-header">
  ...
  <a href="index2.html" class="logo">
    ...
    <span class="logo-mini">AHM</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg">Ameera Hati Mulia</span>
  </a>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-right">
                <a href="<?php echo base_url() . 'administrator/logout' ?>" class="btn btn-default btn-flat">Logout</a>
              </div>
            </li>
          </ul>
        </li>
